...
from python_aioarango.errno import DATABASE_NOT_FOUND, FILE_NOT_FOUND, FORBIDDEN
...
async def test_backup_management(
    sys_db: StandardDatabase, bad_db: StandardDatabase, enterprise
):
    if not enterprise:
