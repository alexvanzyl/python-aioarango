...
async def test_collection_attributes(
    db: StandardCollection, col: StandardCollection, username
):
...
async def test_collection_misc_methods(
    col: StandardCollection, bad_col: StandardCollection, cluster
):
    # Test get properties
