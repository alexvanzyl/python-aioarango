...
from python_aioarango.errno import DATABASE_NOT_FOUND, FORBIDDEN
...
async def test_cluster_server_id(
...
async def test_cluster_server_role(
    sys_db: StandardDatabase, bad_db: StandardDatabase, cluster
):
    if not cluster:
        pytest.skip("Only tested in a cluster setup")
...
async def test_cluster_server_version(
    sys_db: StandardDatabase, bad_db: StandardDatabase, cluster
):
    if not cluster:
        pytest.skip("Only tested in a cluster setup")
...
async def test_cluster_server_engine(
    sys_db: StandardDatabase, bad_db: StandardDatabase, cluster
):
    if not cluster:
        pytest.skip("Only tested in a cluster setup")
...
async def test_cluster_server_statistics(
    sys_db: StandardDatabase, bad_db: StandardDatabase, cluster
):
    if not cluster:
        pytest.skip("Only tested in a cluster setup")
...
async def test_cluster_toggle_maintenance_mode(
    sys_db: StandardDatabase, bad_db: StandardDatabase, cluster
):
    if not cluster:
        pytest.skip("Only tested in a cluster setup")
...
async def test_cluster_endpoints(
    db: StandardDatabase, bad_db: StandardDatabase, cluster
):
    if not cluster:
        pytest.skip("Only tested in a cluster setup")
...
async def test_cluster_server_count(
    db: StandardDatabase, bad_db: StandardDatabase, cluster
):
    if not cluster:
        pytest.skip("Only tested in a cluster setup")
