...
from python_aioarango.database import BatchDatabase, StandardDatabase
...
async def test_batch_wrapper_attributes(
...
async def test_batch_execute_without_result(
