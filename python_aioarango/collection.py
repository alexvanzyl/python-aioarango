...
from python_aioarango.cursor import Cursor
...
from python_aioarango.typings import Fields, Headers, Json, Params
from python_aioarango.utils import get_doc_id, is_none_or_int, is_none_or_str
...
class Collection(ApiGroup):
    ...
    async def checksum(
        self, with_rev: bool = False, with_data: bool = False
    ) -> Result[str]:
    ...
    async def get_many(
        self, documents: Sequence[Union[str, Json]]
    ) -> Result[List[Json]]:
    ...
    async def delete_index(
        self, index_id: str, ignore_missing: bool = False
    ) -> Result[bool]:
        """Delete an index.
