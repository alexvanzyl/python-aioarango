...
from python_aioarango.api import ApiGroup
...
from python_aioarango.formatter import format_graph_properties
...
from python_aioarango.typings import Json, Jsons
from python_aioarango.utils import get_col_name, get_doc_id
...
class Graph(ApiGroup):
    ...
    def _get_col_by_vertex(self, vertex: Union[str, Json]) -> VertexCollection:
        ...
        :rtype: python_aioarango.collection.VertexCollection
        """
    ...
    def _get_col_by_edge(self, edge: Union[str, Json]) -> EdgeCollection:
        ...
        :rtype: python_aioarango.collection.EdgeCollection
        """
    ...
    async def properties(self) -> Result[Json]:
        ...
        :return: Graph properties.
        :rtype: dict
        :raise python_aioarango.exceptions.GraphPropertiesError: If retrieval fails.
        """
    ...
    async def vertex_collections(self) -> Result[List[str]]:
        ...
        :rtype: [str]
        :raise python_aioarango.exceptions.VertexCollectionListError: If retrieval fails.
        """
        request = Request(
            method="get",
            endpoint=f"/_api/gharial/{self._name}/vertex",
    ...
    async def create_vertex_collection(self, name: str) -> Result[VertexCollection]:
        ...
        :return: Vertex collection API wrapper.
        :rtype: python_aioarango.collection.VertexCollection
        :raise python_aioarango.exceptions.VertexCollectionCreateError: If create fails.
        """
        request = Request(
            method="post",
            endpoint=f"/_api/gharial/{self._name}/vertex",
    ...
    async def delete_vertex_collection(
        ...
        :rtype: bool
        :raise python_aioarango.exceptions.VertexCollectionDeleteError: If delete fails.
        """
        request = Request(
            method="delete",
    ...
    async def edge_definitions(self) -> Result[Jsons]:
        ...
        :rtype: [dict]
        :raise python_aioarango.exceptions.EdgeDefinitionListError: If retrieval fails.
        """
        request = Request(method="get", endpoint=f"/_api/gharial/{self._name}")
    ...
    async def create_edge_definition(
        ...
        :return: Edge collection API wrapper.
        :rtype: python_aioarango.collection.EdgeCollection
        :raise python_aioarango.exceptions.EdgeDefinitionCreateError: If create fails.
        """
        request = Request(
            method="post",
    ...
    async def replace_edge_definition(
        ...
        :return: Edge collection API wrapper.
        :rtype: python_aioarango.collection.EdgeCollection
        :raise python_aioarango.exceptions.EdgeDefinitionReplaceError: If replace fails.
        """
        request = Request(
            method="put",
    ...
    async def delete_edge_definition(
        ...
        :rtype: bool
        :raise python_aioarango.exceptions.EdgeDefinitionDeleteError: If delete fails.
        """
        request = Request(
            method="delete",
    ...
    async def traverse(
        ...
        :rtype: dict
        :raise python_aioarango.exceptions.GraphTraverseError: If traversal fails.
        """
    ...
    async def has_vertex(
        ...
        :rtype: bool
        :raise python_aioarango.exceptions.DocumentGetError: If check fails.
